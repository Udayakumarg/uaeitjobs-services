    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/jobs/**", "/api/v1/skills/**", "/api/v1/locations", "/api/v1/stats", "/api/v1/seo/**", "/api/v1/companies", "/api/v1/companies/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/applications", "/api/v1/applications/track").hasRole("JOB_SEEKER")
                        .requestMatchers(HttpMethod.GET, "/api/v1/applications", "/api/v1/applications/job-ids").hasRole("JOB_SEEKER")
